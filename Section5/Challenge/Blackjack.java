...
public class Blackjack {
    ...
    public static void main(String[] args) {
        ...
        //       – Print them: \n You get a \n" + <randomCard> + "\n and a \n" + <randomCard>
        int randomCardOne = drawRandomCard();
        int randomCardTwo = drawRandomCard();

        System.out.println("\n You get a \n " + cardString(randomCardOne) + "\n and a \n" + cardString(randomCardTwo) + "\n");

        //Task 5 – Print the sum of your hand value.
        //       – print: your total is: <hand value>

        int handValue = randomCardOne+randomCardTwo;
